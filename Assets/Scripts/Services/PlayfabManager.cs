...
namespace Services {
	...
	internal sealed class PlayfabManager : IPlayfabManager {
		...
		public void GetData(string playfabId, Action<Dictionary<string, string>> successCallback, Action<PlayFabError> errorCallback
				, params string[] keys) {
		...
		public void RegisterUser(string username, string password, string email, Action<RegisterPlayFabUserResult> successCallback
				, Action<PlayFabError> failuerCallback) {
			PlayFabClientAPI.RegisterPlayFabUser(
					new RegisterPlayFabUserRequest { Username = username, Password = password, Email = email, RequireBothUsernameAndEmail = true }
					, successCallback
					, failuerCallback
			);
		}

		public void LoginUser(string username, string password, Action<LoginResult> successCallback, Action<PlayFabError> failuerCallback) {
