    ...
    internal sealed class HowToPlayView : MonoBehaviour
    {
        ...
        private void UpdateButtonsInteractivity()
        {
            _nextPageButton.interactable = !_pageIsMoving
                                           && _rulesScroll.content.anchoredPosition.x >
                                           -(_rulesScroll.content.rect.width - _rulesScroll.viewport.rect.width);
        ...
        {
            var nextContentXPosition = _rulesScroll.content.anchoredPosition.x +
                                       (_rulesScroll.viewport.rect.width + _contentHorizontalGroup.spacing);
