...
{
    internal sealed class LobbyScreenController : IConnectionCallbacks, ILobbyCallbacks, IMatchmakingCallbacks,
        IInRoomCallbacks
        , ILobbyStatusDisplayer, IRoomEventsCallbacks, IDisposable
    {
        ...
        private void SwitchRoomToLobbyPanel()
        {
            _roomPanelController.HidePanel(
                onPanelHiddenCallback: () =>
                    _lobbyPanelController.ShowPanel(onPanelShownCallback: FinishLobbyPanelShown)
            );
