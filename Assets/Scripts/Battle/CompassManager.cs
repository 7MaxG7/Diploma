...
namespace Services
{
    internal sealed class CompassManager : ICompassManager
    {
        ...
        {
            if (_player == null || _playersInteractionManager.ClosestFightingEnemyPlayer == null ||
        ...
        {
            return (_playersInteractionManager.ClosestFightingEnemyPlayer.Transform.position -
