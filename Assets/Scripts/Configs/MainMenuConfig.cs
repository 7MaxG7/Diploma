...
namespace Infrastructure {
	...
	internal class MainMenuConfig : ScriptableObject {
		...
		[Header("Log in")]
		[SerializeField] private string _confirmLoginAccountButtonText;
		...
		[Tooltip("Delay in ms before panel hides after success opration")]
		[SerializeField] private int _successfulStatusDelay;
		[Header("Main lobby")]
		...
		[Header("Games lobby")]
		[SerializeField] private float _lobbyPanelFadingDuration;
