...
namespace Infrastructure
{
    ...
    internal class UiConfig : ScriptableObject
    {
        ...
        [Header("Skills")] [SerializeField] private SkillUiItemView _skillUiItemPrefab;

        [Tooltip("Time after level up before choosing skills ui appears")] [SerializeField]
        private float _skillChooserActivationDelay;

        [Header("Result panel")] [SerializeField]
        private string _winResultText;
        ...
        private int _hpBarAnimationDurationInFrames;
