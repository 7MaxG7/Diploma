...
namespace Infrastructure
{
    ...
    internal class MissionConfig : ScriptableObject
    {
        ...
        [Tooltip("Max distance for players fight logic")] [SerializeField]
        private float _playersFightDistance;

        [Tooltip("Delay before final mission curtain in millisec")] [SerializeField]
        private int _endMissionDelay;
