...
namespace Units
{
    ...
    internal class MonstersConfig : ScriptableObject
    {
        ...
        [Tooltip("Offset of monsters spawns from screen border")] [SerializeField]
        private float _horizontalSpawnFromScreenOffset;

        [Tooltip("Offset of monsters spawns from screen border")] [SerializeField]
        private float _verticalSpawnFromScreenOffset;
